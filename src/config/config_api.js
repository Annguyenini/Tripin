...
export const COMPLETE_SIGNUP_PROVIDER_API = BASE_API + '/auth/provider/complete-signup'
...
export const DELETE_TRIP_COORDINATE = BASE_API + BASE_TRIP_CONTENTS_API + '/delete-coordinate'
