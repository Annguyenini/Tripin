...
export default function LoadingScreen({ onDone, steps = null }) {
  const DEFAULT_STEPS = [
    "plotting your route...",
    "syncing coordinates...",
    "loading memories...",
    ...
    setTimeout(() => {
      Animated.parallel([
        ...
        LETTERS.forEach((_, i) => {
          ...
          setTimeout(() => {
            Animated.parallel([
              Animated.timing(la.opacity, {
                toValue: 1,
                duration: 280,
                useNativeDriver: true,
              }),
              Animated.spring(la.translateY, {
                toValue: 0,
                tension: 80,
                friction: 9,
                useNativeDriver: true,
        ...
        const runScan = () => {
          ...
          Animated.timing(scanX, {
            ...
            if (finished) setTimeout(runScan, 700);
          });
        };
        runScan();
  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.scanTrack} pointerEvents="none">
        <Animated.View
          style={[s.scanLine, { transform: [{ translateX: scanX }] }]}
        />
      </View>
