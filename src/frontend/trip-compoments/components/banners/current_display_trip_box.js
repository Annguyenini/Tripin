...
export const DisplayTripBox = ({ isFullDisplay, onHide }) => {
  ...
  useEffect(() => {
    ...
    if (tripData) {
      trip_coordinates = CurrentDisplayCoordinateObserver.CoordsArray[
        ...
        ? CurrentDisplayCoordinateObserver.CoordsArray[tripData.trip_id]
        : [];
    }
  ...
  useEffect(() => {
    ...
    CurrentDisplayCoordinateObserver.attach(
      ...
      CurrentDisplayCoordinateObserver.GENERATE_KEY(tripData.trip_id),
    );
    ...
    <View style={currentTripDisplayBoxStyle.wrapper}>
      {isFullDisplay && (
        <View style={currentTripDisplayBoxStyle.card}>
          ...
          <Text style={currentTripDisplayBoxStyle.arrowText}>📤</Text>
            ...
            <TouchableOpacity
              onPress={onClose}
              style={currentTripDisplayBoxStyle.closeButton}
            >
          ...
          <View style={currentTripDisplayBoxStyle.bottomSection}>
            ...
            <View style={currentTripDisplayBoxStyle.imageContainer}>
              <Image
                ...
                source={
                  tripData.image ? { uri: tripData.image } : default_image
                }
              />
            </View>
            ...
            <View style={currentTripDisplayBoxStyle.infoContainer}>
              ...
              <View style={currentTripDisplayBoxStyle.infoRow}>
                <Text style={currentTripDisplayBoxStyle.infoLabel}>
                  Total Distance
                </Text>
                <Text style={currentTripDisplayBoxStyle.infoValue}>
                  {distance.km !== 0 ? distance.km + " km " : ""}
                  {distance.m !== 0 ? distance.m + " m" : ""}
                </Text>
              </View>
            ...
            <Text style={currentTripDisplayBoxStyle.tripName}>
              {tripData.trip_name}
            </Text>
          </View>
        </View>
      ...
      {!isFullDisplay && (
        <View style={currentTripDisplayBoxStyle.minimizecard}>
          <TouchableOpacity
            style={currentTripDisplayBoxStyle.minimizearrowButton}
            onPress={onHide}
          >
            <Text style={currentTripDisplayBoxStyle.arrowText}>←</Text>
          </TouchableOpacity>
