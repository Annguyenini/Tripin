...
const CameraZoomLayout = ({ callZooming }) => {
  ...
  const Zoom_mode_gesture = Gesture.Pan().onEnd((e) => {
            ...
            <View
              ...
              style={
                index === curIndex.value
                  ? camera_zoom.curent_zoom_mode_overlay
                  : camera_zoom.zoom_mode_overlay
              }
            >
              <Text
                key={index}
                style={
                  index === curIndex.value
                    ? camera_zoom.current_zoom_text_mode
                    : camera_zoom.zoom_text
                }
              >
                {mode}
              </Text>
