...
class Config:
    ...
    def __init__(self):
        ...
        self.config.read('server_side/assets/configs/Confignure.ini')

        # paths
        self._private_keep_path = self.config.get('paths','private_key',fallback=None)
        self._public_keep_path = self.config.get('paths','public_key',fallback=None)
        ...
        # read keys
        with open(self._private_keep_path,'r') as f:
